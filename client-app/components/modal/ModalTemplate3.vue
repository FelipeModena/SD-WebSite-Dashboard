<template>
  <div>
    <b-modal
      id="modal-componentes-template-3"
      size="xl"
      hide-footer
      hide-header
    >
      ...
      <div class="p-3">
        ...
        <b-container
          ...
          class="configuracoes-forms-modal-componentes configuracoes-forms"
        >
        <div class="pb-4  configuracoes-forms-modal-componentes border-bottom border-primary ">
          <label for="modal-pagina-modal-comp-banner-principal-btn1"
                >Botão de ação</label
              >
              <br />
          ...
          <b-row>
            <b-col>
              ...
              <label
                ...
                >Cor de fundo do carrousel</label
              >
              <ColorPicker
                v-model="componente.corSubTitulo"
                id="modal-pagina-modal-comp-banner-principal-banner-cor-fundo-carrousel"
              />
              <br />
              <label for="modal-pagina-modal-comp-banner-principal-btn1"
                >Botão de ação</label
...
export default {
  ...
  methods: {
    ...
    async saveAlteracoes(save) {
      ...
      this.componente = {};
      this.imgsDeletadas = [];
      this.$bvModal.hide("modal-componentes-template-3");
    },
    ...
    getCompoenenteEPaginaNome(nomePagina, componente) {
      ...
      this.$bvModal.show("modal-componentes-template-3");
    },
  },
};
</script>
